...
import getCase from '@salesforce/apex/comboboxWithDatatable.getCase';

const columns = [
    { label : 'Case Number', fieldName : 'CaseNumber'}
   
]
export default class Lab3Child extends LightningElement {
    @track value = '';
    @track optionsArray = []; //this array will store the options for combobox
    @track cardVisible  = false;
    @api data = []; // use for storing contact details in datatable
    ...
    handleChangeValue(event){
        ...
        const selectedEvent = new CustomEvent("onaccountchange", {
